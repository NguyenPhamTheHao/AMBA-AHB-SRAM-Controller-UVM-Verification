module sram(
    ...
    //MEMORY OF SRAM
    //---Bank 0 ---
    logic [7:0] sram0_0 [0:8192];
    logic [7:0] sram0_1 [0:8192];
    logic [7:0] sram0_2 [0:8192];
    logic [7:0] sram0_3 [0:8192];
    //---Bank 1 ---
    logic [7:0] sram1_0 [0:8192];
    logic [7:0] sram1_1 [0:8192];
    logic [7:0] sram1_2 [0:8192];
    logic [7:0] sram1_3 [0:8192];

    // SIGNAL FOR SELECTING BANK
    logic bank_sel=A[15];

    //SIGNAL FOR ROW ADDRESS OF EACH SRAM
    logic [12:0] row_addr=A[14:2];
